...
df1 = df.groupby('PostalCode')['Neighborhoods'].apply(','.join).reset_index()
df2 = df[['PostalCode', 'Borough']]
df = df1.merge(df2, on = 'PostalCode', how = 'inner')
...
# ### Get latitudes and longitudes of each postal code through csv file
...
# ### Assign latitudes and longitudes to original dataframe of neighborhoods information about Toronto

# In[125]:


df = df.merge(df_ll, on = 'PostalCode', how = 'inner')
df
